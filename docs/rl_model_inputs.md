...
Character identity is a one-hot vector with this order:
...
This is simple and works for the current fixed roster. It will not generalize to
unseen characters without retraining or changing the encoder.
...
- changing character order in the identity one-hot;
